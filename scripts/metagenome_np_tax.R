...
myotutable = read.table("ngs4_np_tax_table.tsv", sep = "\t", header=T, check.names=F, comment.char="", skip = 0, quote = "")
...
amp_heatmap(amp_subset_taxa(dataset, tax_vector = "K__Unclassified", remove = T, normalise = F), 
            #group_by = "site",
