...
# load tables 
summary = read.table("ngs4_tax_stats.tsv", sep="\t", header=T, comment.char = "", quote = "\"", check.names = F)
...
# export table
write.table(stats_table, file="ngs4_tax_report.tsv", row.names=F, sep = "\t", quote=FALSE)
