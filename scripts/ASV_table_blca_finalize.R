...
tax_info[] = lapply(tax_info, gsub, pattern = "unidentified bacterium.*", replacement = "Unclassified")
tax_info[] = lapply(tax_info, gsub, pattern = "bacterium .*", replacement = "Unclassified")
...
tax_info[] = lapply(tax_info, gsub, pattern = "Unclassified", replacement = NA)
...
# Export data
amp_export_otutable(dataset, "../ASV_table_BLCA", sep = "\t", extension = "tsv")
